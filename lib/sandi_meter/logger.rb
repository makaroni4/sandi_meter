...
module SandiMeter
  class Logger
    ...
    def log_line(data)
      log_line_data = []
      log_line_data << data[:first_rule][:total_classes_amount]
      log_line_data << data[:first_rule][:small_classes_amount]
      log_line_data << data[:second_rule][:total_methods_amount]
      log_line_data << data[:second_rule][:small_methods_amount]
      log_line_data << data[:third_rule][:total_method_calls]
      log_line_data << data[:third_rule][:proper_method_calls]
      log_line_data << data[:fourth_rule][:total_controllers_amount]
